// ListNest Family Chat Push Notification API
// Sends push notifications to family members when a chat message is sent
...
module.exports = async function handler(req, res) {
    ...
    const { familyId, senderUid, senderName, text } = req.body || {};
    ...
    try {
        ...
        // Filter out sender's own subscriptions
        const targetSubs = subsSnapshot.docs.filter(doc => doc.data().userId !== senderUid);
        ...
        const truncatedText = text ? text.substring(0, 100) : '';
